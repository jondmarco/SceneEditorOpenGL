...
void TextRenderer::Initialize()
{
	...
	{
		Logger::LogError(LOG_CHANNEL, "Failed to initialize FreeType Library");
	}
	...
	{
		Logger::LogError(LOG_CHANNEL, "Failed to load font");
	}
	...
	textShader = new Shader("Assets/Shaders/TextVertexShader.glsl", "Assets/Shaders/TextFragmentShader.glsl");
	CreateRenderData();
}
...
void TextRenderer::LoadCharacters(FT_Face face)
{
	...
	for (GLubyte c = 0; c < 128; c++)
	{
		...
		{
			Logger::LogError(LOG_CHANNEL, "Failed to load  Glyph");
			continue;
		}
